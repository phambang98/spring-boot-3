    ...
    var slotMachine = function () {
      ...
      var credits = 15,
        ...
        spinSlot = function () {
          ...
          if (spinning == 0) {
            ...
            spin[0] = parseInt(String(Math.random() * 23));
            spin[1] = parseInt(String(Math.random() * 23));
            spin[2] = parseInt(String(Math.random() * 23));

            $('#slot-trigger').addClass('slot-triggerDisabled');

            $('img.slotSpinAnimation').show();

            $('#wheel1 img:first').css('top', -(spin[0] * 44 + 19) + 'px');
            $('#wheel2 img:first').css('top', -(spin[1] * 44 + 20) + 'px');
            $('#wheel3 img:first').css('top', -(spin[2] * 44 + 20) + 'px');
            ...
            setTimeout(function () {
              stopSpin(1);
            }, 1500 + parseInt(String(1500 * Math.random())));
      ...
      return {
        ...
        init: function () {
          ...
          $('#wheel1 img:first').css('top', -(parseInt(String(Math.random() * 23 * 40))) + 'px');
          $('#wheel2 img:first').css('top', -(parseInt(String(Math.random() * 23 * 44))) + 'px');
          $('#wheel3 img:first').css('top', -(parseInt(String(Math.random() * 23 * 44))) + 'px');
