...
@Component({
  selector: 'app-cherry-charm',
  templateUrl: './cherry-charm.component.html',
  styleUrls: ['./cherry-charm.component.scss']
})
export class CherryCharmComponent implements OnInit {
  ...
  private knobPullSound = '../../../assets/cherry-charm/audio/knob-pull.mp3';
  private spinningSound = '../../../assets/cherry-charm/audio/spinning.mp3';
  private payOutSound = '../../../assets/cherry-charm/audio/pay-out.wav';
  ...
  public playAudio(src) {
    let audio = new Audio();
    audio.src = src; // "../../../assets/cherry-charm/audio/spinning.mp3";
    audio.load();
    audio.play();
  }
