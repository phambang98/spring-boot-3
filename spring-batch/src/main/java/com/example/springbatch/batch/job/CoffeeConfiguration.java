...
import com.example.springbatch.batch.mapper.CustomLineMapper;
import com.example.springbatch.batch.partitioner.CoffeePartitioner;
import com.example.springbatch.batch.tasklet.CoffeeRemoveTasklet;
import com.example.springbatch.batch.tasklet.FileInputTasklet;
import com.example.springbatch.batch.validator.CoffeeBeanValidator;
import com.example.springbatch.batch.writer.CoffeeWriter;
import com.example.springbatch.batch.writer.CustomItemWriter;
import com.example.springbatch.batch.configuration.BatchConfiguration;
import com.example.springbatch.batch.writer.ErrorUploadFileWriter;
...
public class CoffeeConfiguration extends BatchConfiguration {
    ...
    @Bean
    public Job coffeeJob(JobRepository jobRepository, @Qualifier("checkExistsFileCoffeeStep") Step checkExistsFileCoffeeStep,
