...
insert into PRIZE_GROUP(DESCRIPTION, DATE_TIME, STATUS, LAST_APPROVE_BY, LAST_APPROVE_DATE, LAST_UPDATE_BY,
                        LAST_UPDATE_DATE)
VALUES ('nhom chuc may man lan sau', current_date, 'A', 'SYSTEM', current_date, 'SYSTEM', current_date);
...
insert into PRIZES(PRIZE_GROUP_ID, DESCRIPTION, LUCKY_NUMBER_FROM, LUCKY_NUMBER_TO, IMAGE_URL, TYPE, DISPLAY_NUMBER,
                   QUANTITY, STATUS, LAST_APPROVE_BY, LAST_APPROVE_DATE, LAST_UPDATE_BY, LAST_UPDATE_DATE)
VALUES (1, 'giai 3', 40, 60, NULL, '3', 3, 10, 'A', 'SYSTEM', current_date, 'SYSTEM', current_date);



insert into PRIZES(PRIZE_GROUP_ID, DESCRIPTION, LUCKY_NUMBER_FROM, LUCKY_NUMBER_TO, IMAGE_URL, TYPE, DISPLAY_NUMBER,
                   QUANTITY, STATUS, LAST_APPROVE_BY, LAST_APPROVE_DATE, LAST_UPDATE_BY, LAST_UPDATE_DATE)
VALUES (2, 'Chúc bạn may mắn lần sau', NULL, NULL, NULL, NULL, NULL, NULL, 'A', 'SYSTEM', NULL, 'SYSTEM', NULL);
